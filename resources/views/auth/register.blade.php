...
<form method="POST" action="{{ route('register') }}" class="form-login register-form">
  ...
  <div class="form-group input-lock">
    ...
    <input id="cAccName" type="text" class="form-control @error('cAccName') is-invalid @enderror"
      placeholder="Nhập tên tk" name="cAccName" value="{{ old('cAccName') }}" required autocomplete="cAccName"
      autofocus>
    @error('cAccName')
    <span class="invalid-feedback" role="alert">
      <strong>Tài khoản đã tồn tại.</strong>
  ...
  <div class="form-group input-lock">
    ...
    <input id="password1-confirm" type="password" class="form-control" name="password1_confirmation"
      placeholder="Nhập lại mật khẩu cấp 1" required autocomplete="new-password">
  </div>
  ...
  <div class="form-group input-lock">
    ...
    <input id="password2-confirm" type="password" class="form-control" name="password2_confirmation"
      placeholder="Nhập lại mật khẩu cấp 2" required autocomplete="new-password">
  </div>

  <div class="form-group input-lock input-email">
    <label>Email</label>
    <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email"
      placeholder="Nhập email" value="{{ old('email') }}" required autocomplete="email">
    @error('email')
    <span class="invalid-feedback" role="alert">
      <strong>{{ $message }}</strong>
    </span>
  ...
  <div class="form-group input-lock input-phone">
    ...
    <input id="phone" type="text" class="form-control @error('phone') is-invalid @enderror" name="phone"
      placeholder="Nhập sđt" value="{{ old('phone') }}" required autocomplete="phone">
    @error('phone')
    <span class="invalid-feedback" role="alert">
      <strong>Vui lòng nhập số điện thoại</strong>
    </span>
