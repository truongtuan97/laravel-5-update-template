  ...
  <aside class="main-sidebar">
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        <li class="active"><a href="{{ route('users.show', Auth::user()->id) }}"><i class="fa fa-user"></i> <span>Thông
              tin cá nhân</span></a></li>
        <li class="">
          <a href="{{ route('users.edit', Auth::user()->id) }}"><i class="fa fa-user"></i><span>Sửa thông tin cá
              nhân</span></a>
        </li>
        <li class=""><a href="{{ route('password_c1.users.edit', Auth::user()->cAccName) }}"><i class="fa fa-lock"></i>
            <span>Đổi mật khẩu cấp 1</span></a></li>
        <li class=""><a href="{{ route('password_c2.users.edit', Auth::user()->cAccName) }}"><i class="fa fa-lock"></i>
            <span>Đổi mật khẩu cấp 2</span></a></li>
        <li class=""><a href="{{ route('email.users.edit', Auth::user()->cAccName) }}"><i class="fa fa-envelope-o"></i>
            <span>Đổi Email</span></a></li>
        <li class=""><a href="{{ route('phone.users.edit', Auth::user()->cAccName) }}"><i class="fa fa-phone"></i>
            <span>Đổi SĐT</span></a></li>
        <li class=""><a href="{{ route('lichsunaptien') }}"><i class="fa fa-clock-o"></i> <span>Lịch sử nạp
              tiền</span></a></li>
